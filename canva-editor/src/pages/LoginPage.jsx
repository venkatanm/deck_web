  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--bg)" }}>
      ...
      <div className="relative w-full max-w-sm rounded-2xl p-8" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
        ...
        <h1 className="text-xl font-semibold mb-6" style={{ color: "var(--text-hi)" }}>Sign in</h1>
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "var(--text-lo)" }}>
          ...
          <Link to="/register" className="font-medium transition-colors hover:opacity-80" style={{ color: "var(--cyan)" }}>
            Register
          </Link>
        </p>
      </div>
